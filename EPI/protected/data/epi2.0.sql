...
--
-- Servidor: localhost
-- Tiempo de generación: 07-01-2015 a las 17:40:51
...
(1, NULL, NULL, 1420649371, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
(16, 1419479404, 1419479404, 1420563480, '17.912.202-2', 'scarril@alumnos.ubiobio.cl', '123', NULL, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `proyectoevaluador` (
  ...
  `pre_comentario` text,
  `pre_estadoPostulacion` varchar(25) DEFAULT NULL,
  `pre_estadoEvaluacion` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`pre_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
